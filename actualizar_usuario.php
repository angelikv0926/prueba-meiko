...
if (isset($_GET['id'])){
	$id_usu=intval($_GET['id']);
} else {
	header("location:index.php");
}

$datos_usuario=$Database->consultarUsuarioById($id_usu);
$id = $datos_usuario['id_usu'];
$nombre = $datos_usuario['nomn_usu'];
$apellido = $datos_usuario['ape_usu'];
$email = $datos_usuario['email'];
$pass = $datos_usuario['pass_usu'];
$defaultCountry = $datos_usuario['pais_usu'];


$output = "<select id='$defaultCountry' name='pais' class='".$classes."'>";
...
$plantilla->assign("apellido",$apellido);
...
$plantilla->assign("CONTENIDO_MODULO",$plantilla->fetch("_modificarUsuario.html"));
